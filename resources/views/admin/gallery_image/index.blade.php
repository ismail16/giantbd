...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <a href="{{route('admin.gallery-image.create')}}" class="pull-right btn btn-xs btn-primary"> <i
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($gallery_images as $gallery_image)
                            <tr>
                                ...
                                <td>{{$gallery_image->category}}</td>
                                <td>{{$gallery_image->created_at->format('d M Y')}}</td>
                                <td class="text-center">
                                    <a href="{{ route('admin.gallery-image.edit' ,$gallery_image->id) }}"
                                       class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    <form action="{{ route('admin.gallery-image.destroy',$gallery_image->id ) }}" method="post"
