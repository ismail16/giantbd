...
@section('content')
  ...
  <section id="next_section" class="featured-jobs" >
        ...
        <div class="container featured_jobs_container" style="padding: 0px 90px;">
            ...
            <div style="padding-top: 30px; padding-bottom: 30px;"><h1 class="heading-secondary">Available jobs </h1></div>

            <div class="row" style="min-height: 300px;">
              @foreach($PostJobs as $PostJob)
                <div class="col-sm-6 col-md-6 single_job">
                    <div class="thumbnail">
                        <img src="{{asset('images/PostJob/'.$PostJob->job_image)}}" style="height: 83px; width: 100px;">
                        <a target="_blank" href="{{ route('show_jobs', $PostJob->id)}}" class="feature-link"><h3>{{ $PostJob->title }}</h3></a>
                        <p style="display: -webkit-box; overflow: hidden;line-height: normal;-webkit-line-clamp: 2;-webkit-box-orient: vertical;height: 30px;">{!! $PostJob->details !!}</p>
